...
pub fn run() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            google_calendar::edit_google_calendar_event,
            google_calendar::delete_google_calendar_event,
            google_calendar::keep_google_calendar_version,
            google_calendar::apply_ion_calendar_changes,
            google_calendar::review_google_calendar_differences,
